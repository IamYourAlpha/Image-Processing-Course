...
import numpy as np
from sklearn.cluster import KMeans, MeanShift, AffinityPropagation, spectral_clustering
import argparse
import cv2
import datetime
...
image = cv2.imread('./colorImages/image_1.png')
...
kmeans = MeanShift().fit(reshaped)
#kmeans = KMeans(n_clusters=numClusters, n_init=40, max_iter=500).fit(reshaped)
#kmeans = AffinityPropagation(max_iter=200).fit(reshaped)
